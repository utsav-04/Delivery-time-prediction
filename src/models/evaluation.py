...
# initialize dagshub
import dagshub
dagshub.init(repo_owner='utsav-04',
             repo_name='Delivery-time-prediction',
             mlflow=True)

# set the mlflow tracking server
mlflow.set_tracking_uri("https://dagshub.com/utsav-04/Delivery-time-prediction.mlflow")
...
if __name__ == "__main__":
    ...
    with mlflow.start_run() as run:
        ...
        # log the final model
        #lflow.sklearn.log_model(model,"delivery_time_pred_model",signature=model_signature)
